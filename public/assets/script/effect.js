...
///colors
var backgroundColor = "#0000"; // set transparent background to canvas
var confettiAlpha = 1;  // confetti alpha
var goldPalette = [ `rgba( 255,140,0, ${confettiAlpha} )`,
                    `rgba( 255,223,0, ${confettiAlpha} )`,
